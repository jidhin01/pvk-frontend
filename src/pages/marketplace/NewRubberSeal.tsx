...
import { Stamp, ArrowLeft, CheckCircle2, Palette, Clock, Package, Edit3, ArrowRight, Check, Sparkles } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle, CardFooter } from '@/components/ui/card';
import { toast } from 'sonner';
import { SEAL_TYPES, SEAL_TEMPLATES } from '@/data/mockSealCatalog';
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-muted-foreground text-sm">
                                Design and order your custom rubber seal in 3 easy steps.
                            </p>
                        </div>
                    </div>
                    <Button
                                ...
                                {SEAL_TEMPLATES.map((template) => (
                                    ...
                                    >
                                        ...
                                        <CardContent className="pt-6 pb-4 text-center">
                                            ...
                                            <p className="text-xs text-muted-foreground mb-2">{template.lines} text lines</p>
                                ...
                                <CardHeader className="bg-gradient-to-r from-primary/5 to-transparent pb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground mt-0.5">Your seal is ready to order</p>
                                        </div>
                                    </div>
                                </CardHeader>
                                <CardContent className="pt-6 space-y-6">
                                    {/* Seal Preview */}
                                    <div className="aspect-video bg-gradient-to-br from-muted/50 to-muted/30 rounded-xl border-2 border-dashed border-muted-foreground/20 flex flex-col items-center justify-center p-8">
                                        <div className="p-4 bg-orange-100 dark:bg-orange-900/30 rounded-full mb-4">
                                            <Stamp className="h-12 w-12 text-orange-600 dark:text-orange-400" />
                                        </div>
                                        <h3 className="text-lg font-semibold text-foreground mb-1">Custom Seal Design</h3>
                                        <p className="text-sm text-muted-foreground text-center max-w-sm">
                                            Your configured seal will be manufactured with precision.
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
                                            ...
                                            <p className="text-lg font-semibold capitalize">
                                                {SEAL_TYPES.find(t => t.id === selectedType)?.label || '-'}
                                            </p>
                                        </div>
                                        <div className="p-4 rounded-xl bg-muted/30 border border-border/50">
                                            <div className="flex items-center gap-2 mb-2">
                        ...
                        <CardContent className="space-y-3">
                            <div className="flex justify-between items-center text-sm py-2 border-b border-border/50">
                                ...
                                <span className="font-medium capitalize">
                                    {SEAL_TYPES.find(t => t.id === selectedType)?.label || 'Not selected'}
                                </span>
                            </div>
                            <div className="flex justify-between items-center text-sm py-2 border-b border-border/50">
