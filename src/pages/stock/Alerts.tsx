...
const mockAlerts: Alert[] = [
    ...
    },
    {
        ...
        type: 'dead_stock',
        title: 'Dead Stock Alert - Godown',
        description: 'Legacy Toner Cartridges not moved for 250 days. Consider liquidation or disposal.',
    ...
    // Minimum Stock Alerts
    {
        id: '4',
        type: 'min_stock',
        title: 'Minimum Stock Alert - Critical',
        description: 'Seal Ink - Black is below minimum threshold (25/30 units). Reorder immediately.',
    ...
    },
    {
        ...
        description: 'Lamination Film (Glossy) is running low (45/50 units). Consider reordering.',
    ...
    },
    {
        ...
        description: 'PVC Overlay Film is completely out of stock (0/20 units). Urgent reorder needed!',
    ...
    },
    {
        ...
        type: 'min_stock',
        title: 'Low Stock Warning',
        description: 'Toner - Yellow (HP) below threshold (2/3 units). Production may be affected.',
    ...
    },
    {
        ...
        type: 'min_stock',
        title: 'Low Stock Warning',
        description: 'Corner Cutter Blades running low (8/10 units). Plan for reorder.',
        timestamp: '1 day ago',
        isRead: true,
        priority: 'low',
    },
    ...
    // Exchange Alerts
    {
        ...
        description: 'Premium Gold Cards in shop needs to be exchanged with godown stock due to slow movement.',
        timestamp: '1 day ago',
        isRead: false,
        priority: 'medium',
    },
    {
        id: '10',
        type: 'exchange',
        title: 'Stock Transfer Suggested',
        description: 'A4 Paper (75gsm) excess in godown (~5000). Transfer to shop recommended.',
    ...
    },
    {
        id: '11',
        type: 'exchange',
        title: 'Exchange Required - High Priority',
        description: 'Old Logo Letterheads in shop (120 units) must be returned to godown immediately.',
    ...
    },
    {
        id: '12',
        type: 'exchange',
        title: 'Rebalance Stock',
        description: 'Self-Ink Stamps (Medium) low in shop (35 units). Transfer from godown available.',
        timestamp: '2 days ago',
        isRead: true,
        priority: 'medium',
    },
    ...
    // Additional Alerts for variety
    {
        ...
        description: 'Wedding Card Stock running critically low (45/100 units). Peak season approaching.',
        timestamp: '3 hours ago',
        isRead: false,
        priority: 'high',
    },
    {
        id: '14',
        type: 'dead_stock',
        title: 'Clearance Recommended',
        description: 'Promotional Flyer Stock (500 units) idle for 92 days. Consider discount sale.',
        timestamp: '5 hours ago',
        isRead: false,
        priority: 'medium',
    },
    {
        id: '15',
        type: 'exchange',
        title: 'Godown Overflow',
        description: 'PAN Card Pouches excess stock (500 units). Transfer 200 to shop for accessibility.',
        timestamp: '1 day ago',
        isRead: true,
        priority: 'low',
    },
