        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {SEAL_TYPES.map((type) => {
                ...
                return (
                    ...
                    >
                        {isSelected && (
                            <div className="absolute top-0 right-0 bg-emerald-500 text-white px-2 py-1 rounded-bl-lg z-10 shadow-sm animate-in zoom-in spin-in-12 duration-300">
                        ...
                        <CardHeader className="text-center pb-4 pt-8">
                            <div className={cn(
                                ...
                                isSelected
                                    ...
                                    : "bg-slate-100 text-slate-500 group-hover:bg-emerald-50/50 group-hover:text-emerald-500 group-hover:scale-105"
                            )}>
                                <Icon className="h-10 w-10" />
                            </div>

                            <CardTitle className="text-lg font-bold text-slate-800 dark:text-slate-100 group-hover:text-emerald-700 transition-colors">
                                {type.name}
                            </CardTitle>
                        ...
                        <CardContent className="text-center px-6 pb-6">
                            ...
                            <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                                ...
                                <span className={cn("text-lg font-bold tabular-nums", isSelected ? "text-emerald-600" : "text-slate-900 dark:text-white")}>
                                    ₹{type.basePrice}
                                </span>
                            </div>
                        </CardContent>
